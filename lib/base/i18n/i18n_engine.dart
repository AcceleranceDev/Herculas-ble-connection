...
class I18nEngine {
  Future<void> init(List<Locale> supportedLocales) async {
    ...
    Map<String, Map<String, String>> languagesMatrix = {};
...
extension I18nExtended on String {
  static late TranslationsByLocale _t;
